...
class Parameter:
    ...
    def parse(cls, data: typing.Any):
        ...
        assert isinstance(default, float|None)

        return cls(constraint, key.encode(), default)
    ...
    def parse_parameters(cls, parameters: typing.Any) -> dict[str, typing.Self]:
        ...
        for name, parameter in typing.cast(dict[typing.Any,typing.Any], parameters).items():
